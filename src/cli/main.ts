...
export function formatHelp(binaryName = 'madar'): string {
  return [
    ...
    '    If you update madar, re-run the matching platform install to refresh local agent rules:',
    '    madar claude install | madar cursor install | madar gemini install | madar codex install',
