...
describe('cli main', () => {
  ...
  it('formats help text with supported commands', () => {
    ...
    expect(help).toContain('If you update madar, re-run the matching platform install to refresh local agent rules:')
    expect(help).toContain('madar claude install | madar cursor install | madar gemini install | madar codex install')
